...
$mode = "SEL";
$tips = "";
$tours = "testeyvan@adduniti.online";
$key_code = 'UnitiET$'.$secretkey.$tokenpin.$tokenloginpin.$mode;
$sha256password_externallogin = hash("sha256", $key_code);

$data_externalogin = array("token" => "$tokenpin", "tokenpin" => "$tokenloginpin", "value" => "$value", "clientId" => "$clientId", "label" => "$label", "mode" => "$mode", "tips" => "$tips", "tours" => "$tours", "key" => "$sha256password_externallogin");
